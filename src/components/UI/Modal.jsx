              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  {props.type === "upload" && (
                    <button
                      type="button"
                      className={` bg-blue-200 rounded-md border border-transparent  px-4 py-2 text-sm font-medium  hover:bg-blue-400 focus:outline-none`}
                  ...
                  <button
                    type="button"
                    className={`rounded-md border border-transparent  px-4 py-2 text-sm font-medium  hover:bg-blue-400 focus:outline-none`}
